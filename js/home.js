var App = {
    ...
    // trang chứa nội dung chi tiết (tầng độ sâu + tin tức) —
    // dùng để điều hướng xuyên trang khi 1 mục trong sổ tay
    // được lưu từ trang này nhưng đang được xem lại ở trang khác
    detailPage: "dept-explorer.html",
